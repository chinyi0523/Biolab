...
void printnote(int i) {
    if (i == 33)
        Serial.print("La  Middle");
    if (i == 34)
        Serial.print("Si  Middle");
    if (i == 35)
        Serial.print("Do  High  ");
    if (i == 36)
        Serial.print("Re  High  ");
    if (i == 37)
        Serial.print("Mi  High  ");
    if (i == 38)
        Serial.print("Fa  High  ");
    if (i == 39)
        Serial.print("Sol High  ");
    if (i == 40)
        Serial.print("La  High  ");
    if (i == 41)
        Serial.print("Si  High  ");
}
